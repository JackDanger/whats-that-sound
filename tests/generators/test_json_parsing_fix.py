...
class TestJsonParsingFix:
    ...
    def test_complex_json_parsing(self, generator, mock_llm):
        ...
        metadata = {
            ...
            "total_files": 4,
            "files": [
                {"filename": "01. If I Give My heart.mp3", "artist": "Ruby My Dear", "title": "If I Give My heart"},
                {"filename": "02. Where's The Music.mp3", "artist": "Ruby My Dear", "title": "Where's The Music"},
            ],
            "analysis": {
    ...
    def test_json_parsing_with_extra_text(self, generator, mock_llm):
        ...
        mock_llm.return_value = {
            "choices": [{"text": response_with_extra}]
        }
    ...
    def test_invalid_json_fallback_uses_metadata(self, generator, mock_llm):
        ...
        mock_llm.return_value = {
            "choices": [{"text": "This is not valid JSON at all"}]
        }
