...
class TestAlbumProcessorIntegration:
    ...
    def test_process_single_album_complete_workflow(self, processor, mock_llm, tmp_path):
        ...
        processor.ui.get_user_feedback = Mock(return_value={
            "action": "accept",
            "proposal": {
                "artist": "Test Artist",
                "album": "Test Album",
        ...
        target_dir = processor.file_organizer.target_dir / "Test Artist" / "Test Album (2023)"
    ...
    def test_process_single_album_user_reconsider(self, processor, mock_llm, tmp_path):
        ...
        processor.ui.get_user_feedback = Mock(side_effect=[
            {
                "action": "reconsider",
        ...
        target_dir = processor.file_organizer.target_dir / "Correct Artist" / "Correct Album (2023)"
        assert target_dir.exists()
    ...
    def test_process_multi_disc_album_workflow(self, processor, mock_llm, tmp_path):
        ...
        target_dir = processor.file_organizer.target_dir / "Multi Artist" / "Multi Album (2024)"
        assert target_dir.exists()
...
class TestCollectionProcessorIntegration:
    ...
    def test_process_artist_collection_complete_workflow(self, processor, mock_llm, tmp_path):
    ...
    def test_process_artist_collection_mixed_actions(self, processor, mock_llm, tmp_path):
    ...
    def test_process_artist_collection_no_music_files(self, processor, mock_llm, tmp_path):
        ...
        target_dir = processor.file_organizer.target_dir / "Empty Artist" / "Real Album (2023)"
        assert target_dir.exists()
