...
class TestMetadataExtractor:
    ...
    def test_init(self, metadata_extractor):
        """Test initialization."""
        assert metadata_extractor.SUPPORTED_FORMATS == {
            ".mp3",
            ".flac",
            ".m4a",
            ".mp4",
    ...
    def test_extract_file_metadata_unsupported_format(
    ...
    def test_extract_file_metadata_success(
        self, mock_mutagen, metadata_extractor, tmp_path, mock_audio_file
    ):
    ...
    @patch("mutagen.File")
    def test_extract_file_metadata_no_tags(
        self, mock_mutagen, metadata_extractor, tmp_path
    ):
    ...
    @patch("mutagen.File")
    def test_extract_folder_metadata_success(
        self, mock_mutagen, metadata_extractor, tmp_path
    ):
    ...
    def test_get_tag(self, metadata_extractor):
        ...
        tags = {"TIT2": "Title 1", "TITLE": "Title 2", "\xa9nam": "Title 3"}
    ...
    def test_analyze_metadata_patterns_compilation(self, metadata_extractor):
        ...
        files_metadata = [{"artist": f"Artist {i}"} for i in range(10)]
